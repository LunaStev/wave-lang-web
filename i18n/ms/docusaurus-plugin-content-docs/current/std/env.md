...
Menyediakan carian pembolehubah persekitaran dan kawalan direktori kerja.
...
## 1) Membaca pembolehubah persekitaran rentetan
...
fun main() {
    ...
    if (n >= 0) {
        // buf ialah rentetan yang ditamatkan NUL
...
## 2) Membaca pembolehubah persekitaran integer (jenis hasil generik)
