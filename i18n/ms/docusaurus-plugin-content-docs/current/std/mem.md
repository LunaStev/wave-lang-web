...
Ini ialah utiliti peruntukan/salinan/perbandingan peringkat rendah memori.
...
## 2) Tetapkan semula dan pindahkan salinan selamat
...
fun main() {
    ...
    // Pergerakan selamat kawasan memori bertindih
    mem_move(p + 1, p, 10);
