...
# Cách sử dụng std::mem

Là tiện ích phân bổ/sao chép/so sánh bộ nhớ mức thấp.
...
## 2. Tái phân bổ và sao chép an toàn với di chuyển
