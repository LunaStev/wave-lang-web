...
Wave በተወሰኑ የመጫን ስክሪፕቶች በቀላሉ መጫነት ይቻላል።
በታች ያለውን ትዕዛዝ በተለመዱ ታሪክ የWave ኮምፓይላር (`wavec`) ይቀነበር ይቻላል።

```bash
curl -fsSL https://wave-lang.dev/install.sh | bash -s -- --version <version>
```

የመጫን ስክሪፕት የስርዓቱን አካባቢ ከመነሳት በኋላ የWave ውስጥ ተሞክሮ እና ኮምፓይላርን በስር ያወጣል።
መጀመሪያ አንድ ስም ሳይዘወን ወይም የተለመደ እንደሆነ ያለ የሚገኙበት ወይም የተወሰኑ የመዋቀስ ይቀነበር።

## የማስገባት እንደነሱ ይሁን

የእንግድ ወይም ወደ ፀረ እንዴት ይላል የሚለው ቡድኑን ይፈትናል።

```bash
curl -fsSL https://wave-lang.dev/install.sh | bash -s -- latest
```

አንድ ገንዝጥር ማብላት ከፈለግ በቃ ይጻፈ ወይም በልዕል ዩዋዲ ይወመ ይሄዋል..

```bash
curl -fsSL https://wave-lang.dev/install.sh | bash -s -- --version v0.1.3-pre-beta
```

አንድ ወዮዜ በእይታ (በ) አቅጣጫ ይሁን ይባሉ።
...
የጭነት ስክሪፕት ዋይት አላማ ይቻላል።
በመጀመሪያ LLVM 14 ጋር የተያያዘ የተወሰነ ማቀንበር ባይድን ነቀላል ...
