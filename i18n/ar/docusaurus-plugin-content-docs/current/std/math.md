...
# دليل استخدام std::math

يوفر وظائف للأعداد الصحيحة/العائمة/البتات/النظرية العددية والتقريب التثليثي.
...
## 3. النظرية العددية/التقريب التثليثي
