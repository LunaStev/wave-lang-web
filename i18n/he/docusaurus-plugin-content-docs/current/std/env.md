...
# הוראות שימוש std::env

מספק את היכולת לחפש משתני סביבה ולשלוט על ספריית העבודה.
...
## 2. קריאת משתני סביבה במספרים שלמים (תוצאה גנרית)
