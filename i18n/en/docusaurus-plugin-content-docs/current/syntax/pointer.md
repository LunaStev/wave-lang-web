...
The pointer design of Wave is based on the **Wave Explicit Memory Type Model**.
...
According to this design, in Wave, pointers are represented as a type in the form of `ptr<T>`, clearly indicating that it is a type pointing to the memory address holding a value of a specific type `T`.
This approach treats pointers as part of the type system, rather than as operators or declaration syntax, allowing for a more intuitive and consistent representation of memory structures.
