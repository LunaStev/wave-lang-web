...
`std::buffer` వేరియబుల్ బైట్ బఫర్‌లు మరియు జెనరిక్ బఫర్‌లను అందిస్తుంది.
...
## 2) సాధారణ బఫర్ (`TypedBuffer<T>`)

Waveకి టైప్ ఇన్ఫరెన్స్ లేదు, కాబట్టి టైప్ ఆర్గ్యుమెంట్‌లు పేర్కొనబడ్డాయి.
...
- `elem_size`ని కాలర్ తప్పక సరిగ్గా నమోదు చేయాలి.
- వెలుపలి యాక్సెస్ `false` లేదా డిఫాల్ట్ (`buffer_at` `0`) అందిస్తుంది.
