...
# Utilisation de std::mem

Utilitaire pour l'allocation, la copie et la comparaison de mémoire bas niveau.
...
## 1. Allocation/libération de base
...
## 2. Réallocation et copie sécurisée de mémoire
