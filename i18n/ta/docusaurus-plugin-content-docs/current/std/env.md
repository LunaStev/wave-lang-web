...
சூழல் மாறி தேடல் மற்றும் பணி அடைவு கட்டுப்பாட்டை வழங்குகிறது.
...
## 1) ஸ்டிரிங் சூழல் மாறிகள் படித்தல்
...
fun main() {
    ...
    if (n >= 0) {
        // buf என்பது NUL நிறுத்தப்பட்ட சரம்
...
## 2) முழு எண் சூழல் மாறிகளைப் படித்தல் (பொதுவான முடிவு வகை)
