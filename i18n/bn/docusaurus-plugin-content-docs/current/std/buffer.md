...
`std::buffer` পরিবর্তনযোগ্য বাইট বাফার এবং সাধারণ বাফার সরবরাহ করে।
...
## ২) সাধারণ বাফার (`TypedBuffer<T>`)

Wave-এ কোনো ধরন নির্ণয় হয় না তাই ধরন ইনপুট উল্লেখ করা হয়েছে।
...
- `elem_size` কলকারী দ্বারা সঠিকভাবে ভরাট করা বাধ্যতামূলক।
- ব্যবস্থা সীমার বাইরে হলে তা `false` বা ডিফল্ট মান (`buffer_at` এর জন্য `0`) ফিরিয়ে দেয়।
