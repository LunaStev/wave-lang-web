...
```wave
extern(c) fun ফাংশন নাম (প্যারামিটার...) -> রিটার্ন টাইপ;
```
...
```wave
বাহ্যিক(c) ফান ইনিটউইন্ডো(প্রস্থ: i32, উচ্চতা: i32, শিরোনাম: ptr<u8>);
```
...
```wave
বাহ্যিক(c) {
    ফান ইনিটউইন্ডো(প্রস্থ: i32, উচ্চতা: i32, শিরোনাম: ptr<u8>);
    ফান ক্লোজউইন্ডো();
    ফান বিগিনড্রয়িং();
    ফান এন্ডড্রয়িং();
}
